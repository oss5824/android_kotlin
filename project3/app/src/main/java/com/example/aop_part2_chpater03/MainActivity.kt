package com.example.aop_part2_chpater03
...
class MainActivity : AppCompatActivity() {
    ...
    //View가 다그려지는 시점이 아니기 때문에 lazy로 초기화
    //Vie가 다 그려지는 시점은 onCreate에서
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        numberPicker2
        numberPicker3
        //따로 직접적으로 사용하지않기 때문에 호출해서 lazy하게 초기화
        ...
        openButton.setOnClickListener {
            ...
            if (passwordPreferences.getString("password", "000").equals(passwordFromUser))//초기값
            {
        ...
        changePasswordButton.setOnClickListener {
            ...
            val passwordFromUser =
                "${numberPicker1.value}${numberPicker2.value}${numberPicker3.value}"
            if (changePasswordMode) { //변경된 번호를 저장하는 기능
                //ktx기능
